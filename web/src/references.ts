...
export const REFERENCES: Ref[] = [
  ...
  { id: "proton2025", cat: "method", preprint: true, authors: "Noori A, et al.", title: "Graph AI generates neurological hypotheses validated in molecular, organoid, and clinical systems (PROTON)", venue: "arXiv:2512.13724, 2025 [preprint]", url: "https://arxiv.org/abs/2512.13724" },
  { id: "rlm2025", cat: "method", preprint: true, authors: "Zhang A, Kraska T, Khattab O.", title: "Recursive Language Models (RLM) — depth-1 planner/leaf decomposition for evidence synthesis; the method behind Aitiome's RAG-vs-RLM study", venue: "MIT CSAIL; arXiv:2512.24601, 2025 [preprint]", url: "https://arxiv.org/abs/2512.24601" },
  ...
  { id: "enrich2025", cat: "method", authors: "Rager JE, Koval LE, Hickman E, et al.", title: "The environmental neuroactive chemicals (ENRICH) list — a Chemical Prioritization Index (1,827→250) for biomonitoring and neurotoxicity testing (uses HTS bioactivity; general/developmental scope)", venue: "Environmental Research. 2025;266:120537", url: "https://doi.org/10.1016/j.envres.2024.120537" },
  ...
  { id: "aopsmart2026", cat: "method", preprint: true, authors: "Niu Q, Yan L.", title: "AOP-Smart: a RAG-enhanced large language model framework for adverse outcome pathway analysis (adjacent AOP+AI work)", venue: "arXiv:2604.10874, 2026 [preprint]", url: "https://arxiv.org/abs/2604.10874" },
  { id: "emod2026", cat: "method", preprint: true, authors: "Hench VK, Caufield JH, Moxon SAT, O'Brien JM, Edwards SW.", title: "AOP-Wiki EMOD 3.0: data-model expansions and a content-evaluation framework for agentic AI integration of AOPs and NAMs (FAIR, AI-ready AOP infrastructure)", venue: "arXiv:2605.21645, 2026 [preprint]", url: "https://arxiv.org/abs/2605.21645" },
